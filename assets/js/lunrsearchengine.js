...
function lunr_search(term) {
    ...
    if(term) {
        ...
        if(results.length>0){
            ...
            document.querySelectorAll('#lunrsearchresults ul')[0].innerHTML = "<li class='lunrsearchresult'>Desculpe, nenhum resultado encontrado. Feche e procure por outros termos!</li>";
        }
    }
    return false;
}
